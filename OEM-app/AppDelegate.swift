...
//            let modelURL = NSBundle.mainBundle().URLForResource("OEM_app", withExtension: "momd")
...
//            let storeURL = self.applicationDocumentsDirectory.URLByAppendingPathComponent("OEM_app.sqlite")
//            var error: NSError? = nil
