...
*/
+(UIImage*)imageWithImage:(UIImage*)image withcolorMatrixIndex:(NSInteger)index
{
    ...
    switch (index) {
        ...
        case 1:
            ...
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_lomo];
            
            break;
        case 2:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_heibai];
            
            break;
        case 3:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_huajiu];
            
            break;
        case 4:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_gete];
            
            break;
        case 5:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_ruise];;
            
            break;
        case 6:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_danya];
            
            break;
        case 7:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_jiuhong];
            
            break;
        case 8:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_qingning];
            
            break;
        case 9:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_langman];
            
            break;
        case 10:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_guangyun];
            
            break;
            
        case 11:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_landiao];;
            
            break;
        case 12:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_menghuan];
            
            break;
            
        case 13:
            
            return [FiterView imageWithImage:image withColorMatrix:colormatrix_yese];
